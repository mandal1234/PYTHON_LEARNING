print("Day 22: Advanced Dictionaries")
print("-----------------------------")

lesson = {
    "phase": "Advanced Python",
    "goal": "work confidently with dictionary data",
    "learn": ['get method', 'keys and values', 'looping through dictionaries', 'updating nested values'],
}
