print("Day 90: Resume Mock Interview And Job Application Plan")
print("------------------------------------------------------")

lesson = {
    "phase": "Interview And Job Prep",
    "goal": "prepare to apply for jobs",
    "learn": ['Resume points', 'Project explanation', 'Mock interview', 'Daily application plan', 'Follow-up routine'],
}
