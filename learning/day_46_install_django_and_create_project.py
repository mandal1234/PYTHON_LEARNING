print("Day 46: Install Django And Create Project")
print("-----------------------------------------")

lesson = {
    "phase": "Django",
    "goal": "start the Django part of the course",
    "learn": ['Install Django', 'Check Django version', 'Create project', 'Run development server'],
}
