print("Day 37: Database Design For Tiffin App")
print("--------------------------------------")

lesson = {
    "phase": "SQL And Database",
    "goal": "design tables for your interview project",
    "learn": ['Customer table', 'Menu item table', 'Order table', 'Subscription table', 'Payment table'],
}
