print("Day 27: Pathlib And Project Paths")
print("---------------------------------")

lesson = {
    "phase": "Advanced Python",
    "goal": "manage files and folders cleanly",
    "learn": ['What pathlib is', 'Absolute vs relative paths', 'Creating paths safely', 'Using __file__'],
}
