print("Day 86: Final Project Phase 4 Tests And Deployment")
print("--------------------------------------------------")

lesson = {
    "phase": "Portfolio Project",
    "goal": "finish project for interviews",
    "learn": ['Model tests', 'View tests', 'API tests', 'Deployment', 'README polish'],
}
