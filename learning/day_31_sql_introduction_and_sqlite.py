print("Day 31: SQL Introduction And SQLite")
print("-----------------------------------")

lesson = {
    "phase": "SQL And Database",
    "goal": "understand databases before Django models",
    "learn": ['What a database is', 'What SQL is', 'What SQLite is', 'Why Django uses databases'],
}
