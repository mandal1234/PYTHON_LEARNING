# Day 58 - Permissions And Login Required

Today your goal is to **control who can do what**.

This is part of the **Django** section of your Python/Django job-readiness
course.
...
## Run The Day 58 Example

```powershell
.\env\Scripts\python.exe .\learning\day_58_permissions_and_login_required.py
```

## Practice Task

```powershell
.\env\Scripts\python.exe .\learning\day_58_practice.py
```

## Today Practice Checklist

- Protect admin-like pages
- Allow customers to see own orders
- Explain permission
...
## **What is Permissions And Login Required?**

### 🟩 ANSWER

**Definition**

Permissions And Login Required is today's topic. It helps you **control who can do what**.
...
"Permissions And Login Required helps me control who can do what. I practiced it with small examples and connected it
...
- [ ] I read this lesson.
- [ ] I ran the Day 58 example file.
- [ ] I completed the Day 58 practice file.
