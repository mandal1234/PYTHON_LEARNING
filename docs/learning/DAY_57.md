# Day 57 - User Authentication

Today your goal is to **add login and logout**.
...
## Run The Day 57 Example

```powershell
.\env\Scripts\python.exe .\learning\day_57_user_authentication.py
```

## Practice Task

```powershell
.\env\Scripts\python.exe .\learning\day_57_practice.py
```
...
User Authentication is today's topic. It helps you **add login and logout**.
...
"User Authentication helps me add login and logout. I practiced it with small examples and connected it
...
- [ ] I read this lesson.
- [ ] I ran the Day 57 example file.
- [ ] I completed the Day 57 practice file.
