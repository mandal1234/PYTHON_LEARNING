print("Day 60: Django Messages And Validation")
print("--------------------------------------")

lesson = {
    "phase": "Django",
    "goal": "give users helpful feedback",
    "learn": ['messages framework', 'Success messages', 'Validation messages', 'User experience'],
}
