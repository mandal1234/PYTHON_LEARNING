print("Day 20: Python Coding Style And Debugging")
print("-----------------------------------------")

lesson = {
    "phase": "Developer Tools",
    "goal": "write readable code and inspect problems",
    "learn": ['Readable variable names', 'Small functions', 'Using print for debugging', 'Reading errors calmly'],
}
