print("Day 39: Transactions And Data Integrity")
print("---------------------------------------")

lesson = {
    "phase": "SQL And Database",
    "goal": "understand safe database changes",
    "learn": ['What a transaction is', 'Commit', 'Rollback', 'Why partial saves are dangerous'],
}
