...
Today your goal is to **return HTML using Django templates**.
...
## Run The Day 49 Example

```powershell
.\env\Scripts\python.exe .\learning\day_49_templates.py
```

## Practice Task

```powershell
.\env\Scripts\python.exe .\learning\day_49_practice.py
```
...
Templates is today's topic. It helps you **return HTML using Django templates**.
...
"Templates helps me return HTML using Django templates. I practiced it with small examples and connected it
...
- [ ] I read this lesson.
- [ ] I ran the Day 49 example file.
- [ ] I completed the Day 49 practice file.
