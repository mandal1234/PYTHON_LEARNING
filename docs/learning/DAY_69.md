# Day 69 - Generic Views

Today your goal is to **reduce API boilerplate**.

This is part of the **Django REST Framework** section of your Python/Django job-readiness
course.
...
## Run The Day 69 Example

```powershell
.\env\Scripts\python.exe .\learning\day_69_generic_views.py
```

## Practice Task

```powershell
.\env\Scripts\python.exe .\learning\day_69_practice.py
```

## Today Practice Checklist

- Build menu generic API
- Build order detail API
- Explain generic views
...
Generic Views is today's topic. It helps you **reduce API boilerplate**.
...
"Generic Views helps me reduce API boilerplate. I practiced it with small examples and connected it
...
- [ ] I read this lesson.
- [ ] I ran the Day 69 example file.
- [ ] I completed the Day 69 practice file.
