print("Day 17: Virtual Environments And Pip")
print("------------------------------------")

lesson = {
    "phase": "Developer Tools",
    "goal": "understand isolated Python environments and package installation",
    "learn": ['What a virtual environment is', 'Why projects need separate environments', 'How pip installs packages', 'How requirements files work'],
}
