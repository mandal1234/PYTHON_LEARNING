print("Day 23: Nested Data Structures")
print("------------------------------")

lesson = {
    "phase": "Advanced Python",
    "goal": "store real app-like data using lists and dictionaries together",
    "learn": ['Lists inside dictionaries', 'Dictionaries inside lists', 'Nested loops', 'Real order data structure'],
}
