print("Day 29 Practice: Unit Testing With Unittest")
print("--------------------------------------------")

practice_tasks = ['Write a test idea for total calculation', 'Run the example', 'Explain why testing helps confidence']
