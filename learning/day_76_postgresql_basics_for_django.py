print("Day 76: PostgreSQL Basics For Django")
print("------------------------------------")

lesson = {
    "phase": "Deployment And Production",
    "goal": "prepare for production database work",
    "learn": ['Why PostgreSQL', 'Connection settings', 'psycopg', 'Local vs production database'],
}
