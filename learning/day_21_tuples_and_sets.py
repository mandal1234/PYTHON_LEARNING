print("Day 21: Tuples And Sets")
print("-----------------------")

lesson = {
    "phase": "Advanced Python",
    "goal": "learn more Python collection types",
    "learn": ['What tuples are', 'What sets are', 'When to use each collection', 'How sets remove duplicates'],
}
