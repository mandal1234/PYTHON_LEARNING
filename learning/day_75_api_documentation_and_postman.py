print("Day 75: API Documentation And Postman")
print("-------------------------------------")

lesson = {
    "phase": "Django REST Framework",
    "goal": "document and test APIs professionally",
    "learn": ['Endpoint list', 'Request body', 'Response body', 'Postman collection', 'README API section'],
}
