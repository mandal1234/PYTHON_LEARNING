...
Today your goal is to **write API views manually**.
...
## Run The Day 68 Example

```powershell
.\env\Scripts\python.exe .\learning\day_68_apiview.py
```

## Practice Task

```powershell
.\env\Scripts\python.exe .\learning\day_68_practice.py
```

## Today Practice Checklist

- Create menu list API
- Create menu create API
...
APIView is today's topic. It helps you **write API views manually**.
...
"APIView helps me write API views manually. I practiced it with small examples and connected it
...
- [ ] I read this lesson.
- [ ] I ran the Day 68 example file.
- [ ] I completed the Day 68 practice file.
