print("Day 64: Environment Variables And Settings")
print("------------------------------------------")

lesson = {
    "phase": "Django",
    "goal": "separate development and production secrets",
    "learn": ['SECRET_KEY', 'DEBUG', '.env', 'python-dotenv', 'Production settings'],
}
