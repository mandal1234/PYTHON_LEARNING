print("Day 19: GitHub And Portfolio Repositories")
print("-----------------------------------------")

lesson = {
    "phase": "Developer Tools",
    "goal": "prepare code for public portfolio sharing",
    "learn": ['What GitHub is', 'What a remote repository is', 'What README files do', 'How interviewers look at repositories'],
}
